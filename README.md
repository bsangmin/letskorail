...
예약 -> 결제 단계로 넘어갈 때 디바이스의 [고유번호(uuid)](https://github.com/bsangmin/letskorail/blob/master/letskorail/korail.py#L664)를 요구합니다.

고유번호를 생성하여 발권 할 수 있지만 앱에서 확인하면 다른 디바이스에서 발권한 승차권이라고 표시되어 상황에 따라 부정 승차권으로 간주 됩니다.

예약 후 20분내로 결제를 완료해야 확정이되고 이후엔 자동으로 취소됩니다.
