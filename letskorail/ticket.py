...
class Ticket(object):
    ...
    def __init__(self, data):
        ...
        self.h_sale_dt = tk_info.get("h_sale_dt", tk_info.get("h_orgtk_sale_dt"))
        self.h_tk_ret_pwd = tk_info.get("h_tk_ret_pwd", tk_info.get("h_orgtk_ret_pwd"))
        self.h_sale_sqno = tk_info.get("h_sale_sqno", tk_info.get("h_orgtk_sale_sqno"))
        self.tk_no = "{}-{}-{}-{}".format(
            self.h_wct_no[-5:],
            self.h_sale_dt[-4:],
            self.h_sale_sqno[-5:],
